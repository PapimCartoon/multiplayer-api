...
class SecureClientGameAPI extends BaseGameAPI {
	...
	public function do_juror_store_match_state(key:String, value:Object/*Serializable*/, secret_level:Number, for_user_id:Number):Void { sendDoOperation('do_juror_store_match_state', arguments); }
	public function do_user_store_match_state(key:String, value:Object/*Serializable*/, secret_level:Number):Void { sendDoOperation('do_user_store_match_state', arguments); }
