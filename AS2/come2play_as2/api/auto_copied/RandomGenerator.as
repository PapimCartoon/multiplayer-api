 ...
 * 
 * The generator uses a modulus constant (m) of 2^31 - 1 which instanceof a
 * Mersenne Prime number and a full-period-multiplier of 16807.
 * Output instanceof a 31 bit unsigned integer. The range of values output is
 ...
 * and no division instanceof actually *slower* in flash (both AS2 & AS3) so
 * it's better to use the double-precision floating point version.
 * 
 * @author Michael Baczynski, www.polygonal.de
 */
import come2play_as2.api.auto_copied.*;
	class come2play_as2.api.auto_copied.RandomGenerator
	{
		/**
