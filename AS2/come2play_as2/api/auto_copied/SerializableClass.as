...
class come2play_as2.api.auto_copied.SerializableClass
{
	...
	public static var REPLACE_IN_NAME:String = "come2play_as3.api.";
	...
	public static var isInAPI:Boolean =  REPLACE_IN_NAME=="come2play_as3."+"api.";// I replace 'come2play_as3 . api .', so don't remove the  ."+"
