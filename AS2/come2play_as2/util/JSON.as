	/*
	IMPORTANT: this JSON differs from flex/JSON in these ways:
	1) It uses BaseGameAPI.throwError instead of throw new Error
	2) stringify: it uses:
		if (AS3_vs_AS2.isNumber
		Also, it doesn't use toString, and doesn't print XML nicely.
	3) renamed member parse to p_parse	
	*/
