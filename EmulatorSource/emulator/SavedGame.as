package emulator
{
	...
	public class SavedGame extends SerializableClass
	{
		...
		static public function create(entries:Array,players:Array,finishedGames:Array,extra_match_info:Object,match_started_time:int,name:String,gameName:String):SavedGame
		{
			var res:SavedGame = new SavedGame();
			res.entries = entries.concat();
