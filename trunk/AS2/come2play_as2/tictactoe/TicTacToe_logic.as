 ...
 * A player that fills a whole row, column or diagonal, wins.
 *
...
class come2play_as2.tictactoe.TicTacToe_logic { 	
	...
	public function makeMove(color:Number, row:Number, col:Number):Boolean {
