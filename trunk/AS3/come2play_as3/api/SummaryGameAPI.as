...
//Do not change the code below because this class was generated automatically!
	...
	public  class SummaryGameAPI  {
		...
		,['got_match_started', [['all_player_ids','int[]'], ['finished_player_ids','int[]'], ['extra_match_info','Object'], ['match_started_time','int'], ['user_ids','int[]'], ['keys','String[]'], ['values','Object[]']] ]
		,['do_agree_on_match_over', [['player_ids','int[]'], ['scores','int[]'], ['pot_percentages','int[]']] ]
		...
		,['do_juror_store_match_state', [['secret_level','int'], ['key','String'], ['value','Object'], ['for_user_id','int']] ]
		,['do_user_store_match_state', [['secret_level','int'], ['key','String'], ['value','Object']] ]
		,['got_secure_stored_match_state', [['secret_level','int'], ['user_id','int'], ['key','String'], ['value','Object']] ]
