...
public final class TicTacToe_Main
{
	public function TicTacToe_Main(graphics:MovieClip)
	{
		...
		var WIN_LENGTH:int = AS3_vs_AS2.convertToInt(parameters["WIN_LENGTH"]);
		var PLAYERS_NUM_IN_SINGLE_PLAYER:int = AS3_vs_AS2.convertToInt(parameters["PLAYERS_NUM_IN_SINGLE_PLAYER"]);
