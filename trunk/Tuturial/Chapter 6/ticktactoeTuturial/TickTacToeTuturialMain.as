package ticktactoeTuturial
{
	...
	public class TickTacToeTuturialMain extends ClientGameAPI
	{
		...
		public function TickTacToeTuturialMain(stageMovieClip:MovieClip)
		{
			...
			gameLogic = new TickTacToeTuturialLogic(stageMovieClip,this);
		...
		*/
		override public function gotCustomInfo(infoEntries:Array):void
		{
			...
			gameLogic.stageWidth = T.custom(CUSTOM_INFO_KEY_gameWidth,300) as int;
			gameLogic.stageHeight = T.custom(CUSTOM_INFO_KEY_gameHeight,300) as int;
